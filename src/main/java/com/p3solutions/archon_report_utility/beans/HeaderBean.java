...
public class HeaderBean implements ReportBean {
    ...
    @Builder.Default
    private float rightMargin = 32; // Margin for the right side

    @Builder.Default
    private float topMargin = 40; // Margin for the top

    @Builder.Default
    private float leftMargin = 18; // Margin for the left

    @Builder.Default
    private String fontColor = "030303"; // Background color of the header

    @Builder.Default
    private int fontSize = 16; // Font size for header content
    ...
    @Builder.Default
    private float fitWidth = 50;
    @Builder.Default
    private float fitHeight = 50;
    @Builder.Default
    ...
    @Builder.Default
    private VerticalAlignment logoVerticalAlignment = VerticalAlignment.TOP;


    @Builder.Default
    private HorizontalAlignment logoHorizontalAlignment = HorizontalAlignment.RIGHT;
    @Builder.Default
