...
public class ReportGenerator {
    public static void main(String[] args) {
        try {
            ...
            gridParameters.put("File Count", List.of("1", "2", "3", "4"));
            gridParameters.put("Ingested Count", List.of("1", "2", "3", "4"));
            gridParameters.put("Elapsed Time", List.of("00:02:28.025", "00:03:28.025", "00:04:28.025", "00:05:28.025"));
            gridParameters.put("Status", List.of("Success", "Failed", "Failed", "Success"));

            String value = "User sysadmin (sysadmin@ads.com) exported the audit events for date range 2023-11-07 - 2024-06-12 as CSV";
            ...
            ReportComponent dividerComponent = ReportBuilder.addComponent(buildDividerInputBean(805L, 0.5f,
                    GREY_COLOR, 1, DividerType.PAGE_TO_PAGE));
            ReportComponent tableComponent = ReportBuilder.addComponent(getTableBean(parameters));
            ReportComponent dividerComponent1 = ReportBuilder.addComponent(buildDividerInputBean(760L, 1,
                    GREY_COLOR, 1, DividerType.CONTENT));
            ReportComponent jobSummaryComponent = ReportBuilder.addComponent(buildSummaryBean("Job Summary",
                    GREY_LINE_COLOR, 10, FontType.HELVETICA_BOLD.getFontName(),
                    TextAlignment.LEFT,
                    VerticalAlignment.TOP));
            ReportComponent dividerComponent2 = ReportBuilder.addComponent(buildDividerInputBean(740L, 1L,
                    GREY_COLOR, 1, DividerType.CONTENT));
            ReportComponent jobTableComponent = ReportBuilder.addComponent(getTableBean(jobSummaryParameters));
            ReportComponent dividerComponent3 = ReportBuilder.addComponent(buildDividerInputBean(670L, 1L,
                    GREY_COLOR, 1, DividerType.CONTENT));
            ReportComponent objectiveHeaderComponent = ReportBuilder.addComponent(buildSummaryBean("Objective",
                    GREY_LINE_COLOR, 10, FontType.HELVETICA_BOLD.getFontName(),
                    TextAlignment.LEFT,
                    VerticalAlignment.TOP));
            String reportDescription = "The License Volume Statistics Report provides detailed insights into the utilization of software licenses within an organization. " +
            ...
            ReportComponent fileObjectiveValue = ReportBuilder.addComponent(buildSummaryBean(
                    ...
                    TextAlignment.LEFT,
                    VerticalAlignment.TOP));
            ReportComponent licenseVolumeMetrics = ReportBuilder.addComponent(buildSummaryBean("License Volume Metrics",
                    GREY_LINE_COLOR, 10, FontType.HELVETICA_BOLD.getFontName(),
                    TextAlignment.LEFT,
                    VerticalAlignment.TOP));
            ReportComponent dividerComponent4 = ReportBuilder.addComponent(buildDividerInputBean(625L, 1L,
                    GREY_COLOR, 1, DividerType.CONTENT));
            ReportComponent footerDivider = ReportBuilder.addComponent(buildDividerInputBean(30L, 1L,
                    GREY_COLOR, 1, DividerType.PAGE_TO_PAGE));
...
//            ReportComponent chartComponent = ReportBuilder.addComponent(buildChartCreationConfig());
            ...
            ReportComponent auditComponent = ReportBuilder.addComponent(buildCard("ADS_DEMO_CHECK",
                    CardType.MULTIPLE_DETAILS_INFO, auditParameters
                    , new Date().toString(),
                    ""));
            ReportComponent singleCardComponent = ReportBuilder.addComponent(buildCard(" System | Management | Audit | Export",
